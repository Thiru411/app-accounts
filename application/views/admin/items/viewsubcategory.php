            ...
            <div class="main--menu">
                    ...
                    <div class="d-flex justify-content-between all-invoice-row1 content-value ">
                        ...
                        <div class="align-self-center ">
                            <div class="d-flex">
                                ...
                                <div class="mr-md-3">
                                    <a href="<?php echo base_url()?>item/addsubcategory" class="secoundry-btn">+ New</a>
                ...
                <?php 
                 ...
                 if($existingSubCategory!=false) {
                    ...
                    foreach($existingSubCategory as $info) { ?>
                      <tr><td><?php echo $i++?></td>
                    ...
                    <td>
                          ...
                          <?php if($info->subCategoryStatus	) {?>
                                                         
                            <a href="<?=base_url()?>item/subcategoryupdate/edit/<?=base64_encode($info->sk_subCategory_id)?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                            |<a href="<?=base_url()?>item/subcategoryupdate/delete/<?=base64_encode($info->sk_subCategory_id)?>"><i class="fa fa-trash" aria-hidden="true"></i></a>
                      <?php }else {?>
                            <a href="<?=base_url()?>item/subcategoryupdate/active/<?=base64_encode($info->sk_subCategory_id)?>"><i class="fa fa-check" aria-hidden="true"></i></a>
                          <?php }?>
                          </td>
