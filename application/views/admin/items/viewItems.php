                    ...
                    <div class="d-flex justify-content-between all-invoice-row1 content-value ">
                        ...
                        <div class="align-self-center ">
                            <div class="d-flex">
                                ...
                                <div class="mr-md-3">
                                    <a href="<?php echo base_url()?>item/add-items" class="secoundry-btn">+ New</a>
                            ...
                            <table class="w-100 table-list rem-mt-5 cust-table-mar " id="myTabless">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Part No </th>
                                        <th>Item Name</th><th>MRP </th>
                                        <th>Count Rate</th><th>L-Dealer Rate </th>
                                        <th>S-Dealer rate</th><th>Opening QTY</th>
                                        <th>Tax Percent</th><th>MIN.Order LVL</th>
                                        <th>Re-Order LVL</th>
                                        <th>MAX.Order LVL</th>
                                        <th>Location</th>
                                        <th>Discount Cat</th><th>Purchase Rate</th>
                                        <th>HSN Code</th>                                      
                                        <th>Actions</th>
                                    </tr>
                                </thead>
                 ...
                 if($existingItem!=false) {
                    ...
                    foreach($existingItem as $info) { ?>
                      <tr><td><?php echo $i++?></td>
                        ...
                        <td><?=$info->mrp?></td>
                        <td><?=$info->count_rate?></td>
                        <td><?=$info->l_dealer_rate?></td>
                        <td><?=$info->s_dealer_rate?></td>
                        <td><?=$info->opening_qty?></td>
                        <td><?=$info->tax_percent?></td>
                        <td><?=$info->min_order_lvl?></td>
                        <td><?=$info->re_order_lvl?></td>
                        <td><?=$info->max_order_lvl?></td>
                        <td><?=$info->location?></td>
                        <td><?=$info->discount_cat?></td>
                        <td><?=$info->purchase_rate?></td>
                        <td><?=$info->hsn_code?></td>
                    <td>  
                          <?php if($info->item_status) {?>                       
                            <a href="<?=base_url()?>item/itemupdate/edit/<?=base64_encode($info->sk_item_id)?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                            |<a href="<?=base_url()?>item/itemupdate/delete/<?=base64_encode($info->sk_item_id)?>"><i class="fa fa-trash" aria-hidden="true"></i></a>
                      <?php }else {?>
                            <a href="<?=base_url()?>item/itemupdate/active/<?=base64_encode($info->sk_item_id)?>"><i class="fa fa-check" aria-hidden="true"></i></a>
                          <?php }?>
                          </td>
