         ...
         <div class="main--menu w-100 main-menu-overflow">
                <div class="main-content--">
                    ...
                    <div class="p-3 add-new-2 ">
                        <form class="" method="post"  action="<?php echo base_url()?>item/subcategoryadd">
                            <div class=" col-md-8 pl-0">
                            <?php 
                                 $categoryDetails=$this->im->getCategory('mst_category');
                            ?>
                            <div class="form-row">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-9">
                                    <div class="select-main- valu">
                                       <div class="custom-control custom-radio custom-control-inline">
                                    <input type="text" name="subCategory" class="form-control" placeholder="" aria-label="Last name"required>
                                    </div> 
                                    </div>
