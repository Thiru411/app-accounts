         ...
         <div class="main--menu w-100 main-menu-overflow">
                <div class="main-content--">
                    ...
                    <div class="p-3 add-new-2 ">
                        <form class=" add-item-value" method="post"  action="<?php echo base_url()?>item/additem">
                    ...
                    <option value="<?php echo $inf->sk_category_id ?>"><?php echo $inf->categoryName ?></option>
                    <?php } ?>
                    </select>
                    </div>
                    </div>
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" name="part_no" id="part_no"change="" required>
                                <div>
                                    <p >
                                <div class="pl-2 pt-1">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-9">
                                    <div class="custom-control custom-radio custom-control-inline">
                                <input type="text" name="mrp" id="mrp"required>
                                </div>
                                ...
                                <div class="form-group col-md-9">
                                    <div class="custom-control custom-radio custom-control-inline">
                                <input type="text" name="count_rate" id="count_rate"required>
                                </div>
                                ...
                                <div class="form-group col-md-9">
                                    <div class="custom-control custom-radio custom-control-inline">
                                <input type="text" name="l_dealer" id="part_no"required>
                                </div>
                                ...
                                <div class="form-group col-md-9">
                                    <div class="custom-control custom-radio custom-control-inline">
                                <input type="text" name="s_dealer" id="part_no"required>
                                </div>
                                ...
                                <div class="form-group col-md-9">
                                    <div class="custom-control custom-radio custom-control-inline">
                                <input type="text" name="open_qty" id="part_no"required>
                                </div>
                                ...
                                <div class="form-group col-md-9">
                                    <div class="custom-control custom-radio custom-control-inline">
                                <input type="text" name="tax" id="part_no"required>
                                </div>
                                ...
                                <div class="form-group col-md-9">
                                    <div class="custom-control custom-radio custom-control-inline">
                                <input type="text" name="min_order" id="part_no"required>
                                </div>
                                ...
                                <div class="form-group col-md-9">
                                    <div class="custom-control custom-radio custom-control-inline">
                                <input type="text" name="re_order" id="part_no"required>
                                </div>
                                ...
                                <div class="form-group col-md-9">
                                    <div class="custom-control custom-radio custom-control-inline">
                                <input type="text" name="max_order" id="part_no"required>
                                </div>
                                ...
                                <div class="form-group col-md-9">
                                    <div class="custom-control custom-radio custom-control-inline">
                                <input type="text" name="location" id="part_no"required>
                                </div>
                                ...
                                <div class="form-group col-md-9">
                                    <div class="custom-control custom-radio custom-control-inline">
                                <input type="text" name="discount" id="part_no"required>
                                </div>
                                ...
                                <div class="form-group col-md-9">
                                    <div class="custom-control custom-radio custom-control-inline">
                                <input type="text" name="purchase_rate" id="part_no"required>
                                </div>
                                ...
                                <div class="form-group col-md-9">
                                    <div class="custom-control custom-radio custom-control-inline">
                                <input type="text" name="hsn" id="part_no"required>
                                </div>

                                </div>
                            </div>
                       <button  type="submit" name="submit"value="Update" class="secoundry-btn">Submit</button> 
...
// $(document).ready(function(){
  $("#part_no").change(function(){
    ...
    var data='';
    $.ajax({  
                     url:"<?php echo base_url()?>item/CheckPartNo",  
