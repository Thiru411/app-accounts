         ...
         <div class="main--menu w-100 main-menu-overflow">
                <div class="main-content--">
                    ...
                    <div class="p-3 add-new-2 ">
                        <form class="" method="post"  action="<?php echo base_url()?>item/subcategoryupdate/update/<?=base64_encode($subcategory_id)?>">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-9">
                                    <div class="select-main- valu">
                                        <div class="custom-control custom-radio custom-control-inline">
                                        <input type="text" name="subCategory" value="<?=$subcategoryName?>" class="form-control" placeholder="" aria-label="Last name"required>
                                        </div> 
                                    </div>
                                </div>
                            </div>
