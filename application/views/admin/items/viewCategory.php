            ...
            <div class="main--menu">
                    ...
                    <div class="d-flex justify-content-between all-invoice-row1 content-value ">
                        ...
                        <div class="align-self-center ">
                            <div class="d-flex">
                                ...
                                <div class="mr-md-3">
                                    <a href="<?php echo base_url()?>item/add-category" class="secoundry-btn">+ New</a>
                ...
                <?php 
                 ...
                 if($existingCategory!=false) {
                    ...
                    foreach($existingCategory as $info) { ?>
                      <tr><td><?php echo $i++?></td>
                        <td><?=$info->categoryName?></td>
                   
                    <td>
                         
                          <?php if($info->categoryStatus) {?>
                                                         
                            <a href="<?=base_url()?>item/categoryupdate/edit/<?=base64_encode($info->sk_category_id)?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                            |<a href="<?=base_url()?>item/categoryupdate/delete/<?=base64_encode($info->sk_category_id)?>"><i class="fa fa-trash" aria-hidden="true"></i></a>
                      <?php }else {?>
                            <a href="<?=base_url()?>item/categoryupdate/active/<?=base64_encode($info->sk_category_id)?>"><i class="fa fa-check" aria-hidden="true"></i></a>
                          <?php }?>
                          </td>
