              ...
              <div class="d-flex justify-content-between content-value ">
               ...
               <div class="align-self-center">
                 <div class="d-flex">
                   ...
                   <a href="<?php echo base_url()?>Customer/add_new_customer" class="secoundry-btn">+ New</a>
                   </div>
              ...
              <section class="Customer-content text-center mt-5 mb-5">
                <div class="customercontent-">
                   ...
                   <div class="a-button mb-3">
                     <a href="<?php echo base_url()?>Customer/add_new_customer"class="secoundry-btn">CREATE NEW CUSTOMER</a>
                   </div>
                   ...
                   <div class="d-flex justify-content-center">
                     <p>or using</p>
                     <img class="link-img ml-2" src="images/link-1.PNG">
                     <img class="link-img ml-2" src="images/link-2.png">
                     <img class="link-img ml-2" src="images/link-3.PNG">
                   </div>
