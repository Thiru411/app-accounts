         ...
         <div class="main--menu w-100 main-menu-overflow">
                <div class="main-content--">
                    ...
                    <div class="p-3 add-new-2 ">
                        <form class="" method="post"  action="<?php echo base_url()?>Vendor/vendor_add">
                            <div class=" col-md-8">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-3">
                                    <label data-toggle="tooltip" data-placement="right" title="The contacts which are associated to any Accountant in CRM is of type Business and the other contacts will be of type individual" class="a-border">Vendor Type</label>
                                </div>
                                ...
                                <div class="form-group col-md-9">
                                 ...
                                 <option value="" hidden>Salutation</option>
                                    ...
                                    <option>Dr.</option>
                                        ...
                                        <div class="col-md-4">
                                            <div>
                                                <input type="text" name="first_name" class="form-control" placeholder="Frist name" aria-label="Frist name">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class=" ">
                            ...
                            <div class="form-group">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6 mb-0">
                                        <input type="text" name="company" class="form-control" placeholder="" aria-label="Last name">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="tab-pane fade show active add-new-2 mb-5 pb-5" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <option value="HI">Ajay</option>
                                            ...
                                            <div class="form-group">
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6 mb-0 ">
                                                        <div class="form-group  frist ">
                                                            <select name="payment_terms" class="form-control select2-hidden-accessible  js-example-single w-100  frist " data-plugin="select2" id='select1' tabindex="-1" aria-hidden="true" data-placeholder="Select a state">
                                        <optgroup label="Select Cutomer">
                                        <option value="AK">Zilal</option>
                                        <option value="HI">Ajay</option>
                                        <option value="HI">Ajay</option>
                                        ...
                                        <option value="HI">Ajay</option>
                                                            ...
                                                            <div class="wrapper" id="wrp1" style="display: none;">
                                                                <a href="#" id="type" class="font-weight-300" data-toggle="modal" data-target="#example-Modal"><i class="fa fa-cog" aria-hidden="true"></i> Configure Terms</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6 ">
                                                        <div class="custom-control custom-checkbox">
                                                            ...
                                                            <label class="custom-control-label align-self-center " for="customCheck1">Allow portal access for this Vendor</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <option value="Spanish">Spanish</option>
                                        ...
                                        <!-- </form> -->
                                        <div class="pl-2 note">
                                            <p><strong>Vendor Owner:</strong> Assign a user as the Vendor owner to provide access only to the data of this Vendor.<a href="#"> Learn More</a></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <option value="England">England</option>
                                                    ...
                                                    <div class="col-md-3 align-self-center"> <label for="inputPassword4" class="mb-0">Phone</label></div>
                                                    <div class="col-md-7"><input type="number" name="phone" class="form-control" id="inputPassword4"></div>
                                        ...
                                        <div class="border-yellow">
                                            <div class="ml-3">
                                                ...
                                                <ul class="pl-3">
                                                    ...
                                                    <li>View and edit the address format of your transactions under Settings > Preferences > Vendors and Vendors.</li>
                                                </ul>
                                            </div>
                                        </div>
