         ...
         <div class="main--menu w-100 main-menu-overflow">
                <div class="main-content--">
                    ...
                    <div class="p-3 add-new-2 ">
                        <form class="" method="post" action="<?php echo base_url()?>settings/purposeupdate/update/<?=base64_encode($purpose_id)?>">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-9">
                                    ...
                                    <input type="text" name="purpose" value="<?=$purpose?>" class="form-control" placeholder="" aria-label="Last name"required>
                                    </div>
