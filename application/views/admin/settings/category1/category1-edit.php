         ...
         <div class="main--menu w-100 main-menu-overflow">
                <div class="main-content--">
                    ...
                    <div class="p-3 add-new-2 ">
                        <form class="" method="post" action="<?php echo base_url()?>settings/category1update/update/<?=base64_encode($sk_category1_id)?>">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-9">
                                    ...
                                    <input type="text" name="category1" value="<?=$category1?>" class="form-control" placeholder="" aria-label="Last name"required>
                                    </div>
