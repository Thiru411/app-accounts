...
<?php $this->load->view('admin/inc/menu'); ?>
            ...
            <div class="main--menu">
                    ...
                    <div class="d-flex justify-content-between all-invoice-row1 content-value ">
                        ...
                        <div class="align-self-center ">
                            <div class="d-flex">
                                ...
                                <div class="mr-md-3">
                                    <a href="<?php echo base_url()?>settings/add-category1" class="secoundry-btn">+ New</a>
                ...
                <?php 
                    $i=1;
                 if($existingCategory1!=false) {
                 
                    foreach($existingCategory1 as $info) { ?>
                      <tr><td><?php echo $i++?></td>
                        <td><?=$info->category1?></td>
                   
                    <td>
                         
                          <?php if($info->category1_status) {?>
                                                         
                            <a href="<?=base_url()?>settings/category1update/edit/<?=base64_encode($info->sk_category1_id)?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                            |<a href="<?=base_url()?>settings/category1update/delete/<?=base64_encode($info->sk_category1_id)?>"><i class="fa fa-trash" aria-hidden="true"></i></a>
                      <?php }else {?>
                            <a href="<?=base_url()?>settings/category1update/active/<?=base64_encode($info->sk_category1_id)?>"><i class="fa fa-check" aria-hidden="true"></i></a>
                          <?php }?>
                          </td>
