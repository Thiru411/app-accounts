            ...
            <div class="main--menu">
                    ...
                    <div class="d-flex justify-content-between all-invoice-row1 content-value ">
                        ...
                        <div class="align-self-center ">
                            <div class="d-flex">
                                ...
                                <div class="mr-md-3">
                                    <a href="<?php echo base_url()?>settings/add-customer-type" class="secoundry-btn">+ New</a>
                ...
                <?php 
                 ...
                 if($existingCustomerType!=false) {
                    ...
                    foreach($existingCustomerType as $info) { ?>
                      <tr><td><?php echo $i++?></td>
                        <td><?=$info->customer_type?></td>
                   
                    <td>
                         
                          <?php if($info->customer_type_status) {?>
                                                         
                            <a href="<?=base_url()?>settings/customertypeUpdate/edit/<?=base64_encode($info->sk_customer_type_id)?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                            |<a href="<?=base_url()?>settings/customertypeUpdate/delete/<?=base64_encode($info->sk_customer_type_id)?>"><i class="fa fa-trash" aria-hidden="true"></i></a>
                      <?php }else {?>
                            <a href="<?=base_url()?>settings/customertypeUpdate/active/<?=base64_encode($info->sk_customer_type_id)?>"><i class="fa fa-check" aria-hidden="true"></i></a>
                          <?php }?>
                          </td>
