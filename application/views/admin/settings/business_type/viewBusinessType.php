...
<?php $this->load->view('admin/inc/menu'); ?>
            ...
            <div class="main--menu">
                    ...
                    <div class="d-flex justify-content-between all-invoice-row1 content-value ">
                        ...
                        <div class="align-self-center ">
                            <div class="d-flex">
                                ...
                                <div class="mr-md-3">
                                    <a href="<?php echo base_url()?>settings/add-business-type" class="secoundry-btn">+ New</a>
                ...
                <?php 
                    $i=1;
                 if($existingbusinessType!=false) {
                 
                    foreach($existingbusinessType as $info) { ?>
                      <tr><td><?php echo $i++?></td>
                        <td><?=$info->business_type?></td>
                   
                    <td>
                         
                          <?php if($info->business_type_status) {?>
                                                         
                            <a href="<?=base_url()?>settings/businesstypeupdate/edit/<?=base64_encode($info->sk_business_type_id)?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                            |<a href="<?=base_url()?>settings/businesstypeupdate/delete/<?=base64_encode($info->sk_business_type_id)?>"><i class="fa fa-trash" aria-hidden="true"></i></a>
                      <?php }else {?>
                            <a href="<?=base_url()?>settings/businesstypeupdate/active/<?=base64_encode($info->sk_business_type_id)?>"><i class="fa fa-check" aria-hidden="true"></i></a>
                          <?php }?>
                          </td>
