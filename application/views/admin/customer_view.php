                    ...
                    <div class="d-flex justify-content-between all-invoice-row1 content-value ">
                        ...
                        <div class="align-self-center ">
                            <div class="d-flex">
                                ...
                                <div class="mr-md-3">
                                    <a href="<?php echo base_url()?>customer/add-new-customer" class="secoundry-btn">+ New</a>
                               ...
                               // var_dump($getdetails);
                                ...
                                <img class="black-down-arrow" src="<?php echo base_url()?>/assets/images/down-arrow-black.png">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    ...
                                                    <a class="dropdown-item edit-hover" href="#"><i class="fa fa-envelope-o mr-2" aria-hidden="true"></i>  Email Customer</a>
                                                </div>
                                            </div>
                                        </td>
                                        <?php }?>
...
<script type="text/javascript">  
            function load_add_customer()
            {
                // console.log(zone)
                  $.ajax({  
                     url:"<?php echo  
                     $admin_url?>customer/add-new-customer",    
                     type: "POST",    
               });  
       }  
</script>
                     ...
                     success:function(data){  
                       ///console.log(data);
                        let resp = JSON.parse(data);
                            let client_details =resp.client_details;
                            let customer_address=resp.customer_address;
                            let other_details=resp.customer_other_details;
