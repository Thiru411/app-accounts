            ...
            <div class="main--menu">
                        ...
                        <div class="align-self-center ">
                            <div class="d-flex">
                                ...
                                <span class="sort"></span>
                                            ...
                                            <a class="dropdown-item" href="#"><i class="fa fa-download mr-2 color-grey" aria-hidden="true"></i>Import Vendors</a>
                                            <a class="dropdown-item edit-bor-bot" href="#"><i class="fa fa-upload mr-2" aria-hidden="true"></i>Export Vendors</a>
                                            <a class="dropdown-item edit-bor-bot" href="#"><i class="fa fa-cog mr-2" aria-hidden="true"></i>Vendor Preferences</a>
                                    ...
                                    <tr>
                                        <th>
                                            <div class="custom-control custom-checkbox table-check">
                                                <input type="checkbox" class="custom-control-input checkbox_check" id="customCheck1" name="check-name1">
                                        ...
                                        <th>EMAIL</th>
                                        <th>WORK PHONE</th>
                                        <th class="">RECEIVABLES
                                            <!-- <div class="arr-inline position-relative">
                            <i class="fa fa-caret-down  arrow-black ml-1" aria-hidden="true"></i>
                            <i class="fa fa-caret-up arrow-light" aria-hidden="true"></i>
                          </div> -->
                                        </th>
                                ...
                                foreach($getdetails as $info){?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="custom-control custom-checkbox table-check">
                                                <input type="checkbox" class="custom-control-input mark-clicked" id="customCheck2" name="check-name1">
                                        ...
                                        <td class="onclick-row"><a id="customer" onclick='return check(<?=$info->sk_client_id?>)'><?=$info->primary_contact;?></a></td>
                                        <td class="onclick-row"><?=$info->company_name;?></td>
                                        <td class="onclick-row"><?=$info->email;?></td>
                                        <td class="onclick-row"><?=$info->work_phone;?></td>
                                        <td class="onclick-row"><?=$info->opening_balance;?></td>
                                ...
                                <img class="black-down-arrow" src="<?php echo base_url()?>/assets/images/down-arrow-black.png">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <a class="dropdown-item edit-hover" href="#"><i class="fa fa-pencil mr-2" aria-hidden="true"></i> Edit</a>
                                                    <a class="dropdown-item edit-hover" href="#"><i class="fa fa-envelope-o mr-2" aria-hidden="true"></i>  Email Vendor</a>
                                                </div>
                                            </div>
                                        </td>
                                        <?php }?>
                ...
                <div class="row show-invoice-row d-none">
                                ...
                                <div class="col-md-6 m-0 p-0">
                                    ...
                                    <div class="dropdown Customer-content-- show all-btn">
                                        ...
                                        <div class="dropdown-menu " aria-labelledby="dropdownMenuButton" style="position: absolute; transform: translate3d(0px, 42px, 0px); top: 0px; left: 0px; will-change: transform;" x-placement="bottom-start">
                                            ...
                                            <a class="dropdown-item" href="#">CRM Vendors</a>
                                            <a class="dropdown-item" href="#">Duplicate Vendors</a>
                                            ...
                                            <a class="dropdown-item" href="#">Overdue Vendors</a>
                                            <a class="dropdown-item edit-bor-bot" href="#">Unpaid Vendors</a>
                                ...
                                <div class="col-md-6 m-0 p-0 text-right">
                                    <div class="row float-right">
                                        <div class="col-md-7 text-right p-0">
                                            ...
                                            <a href="<?php echo base_url()?>/Vendor/add_new_vendor">new</a>
                                        ...
                                        <div class="col-md-5 p-0 text-right">
                                            <div class="dropdown rem-arr Customer-content-- show all-btn ">
                                                ...
                                                <span class="sort"></span>
                                                    ...
                                                    <a class="dropdown-item" href="#"><i class="fa fa-download mr-2 color-grey" aria-hidden="true"></i>Import Vendors</a>
                                                    <a class="dropdown-item edit-bor-bot" href="#"><i class="fa fa-upload mr-2" aria-hidden="true"></i>Export Vendors</a>
                                                    <a class="dropdown-item edit-bor-bot" href="#"><i class="fa fa-cog mr-2" aria-hidden="true"></i>Vendors Preferences</a>
                                                    <a class="dropdown-item edit-bor-bot" href="#"><i class="fa fa-upload mr-2" aria-hidden="true"></i>Export Current View</a>
                                                    <a class="dropdown-item edit-bor-bot" href="#"><i class="fa fa-refresh mr-2" aria-hidden="true"></i>Refresh List</a>
                                                    <a class="dropdown-item page-bg" href="#"><i class="fa fa-lightbulb-o mr-2" aria-hidden="true"></i>Page Tips</a>
                                                </div>
                            ...
                            <div class="col-md-7 p-0 text-right">
                                ...
                                <div class="dropdown cust-new-display">
                                    ...
                                    <div class="dropdown-menu " aria-labelledby="dropdownMenuButton">
                                        ...
                                        <a class="dropdown-item spreed-sheet-titles " href="#">Vendors Payment</a>
                                ...
                                <div class="dropdown cust-new-display">
                                    ...
                                    <div class="dropdown-menu " aria-labelledby="dropdownMenuButton">
                                        ...
                                        <a class="dropdown-item spreed-sheet-titles edit-bor-bot" href="#">Email Vendors</a>
                                        ...
                                        <a class="dropdown-item spreed-sheet-titles edit-bor-bot" href="#">Merge Vendors</a>
                                ...
                                <div class="tab-content" id="myTabContent">
                                                    ...
                                                    <div class="ask-review contact row mx-4 p-4">
                                                        ...
                                                        <div class="col-md-10  m-0">
                                                            <div class="client-portal">
                                                                Client Portal allows your Vendors to keep track of all the transactions between them and your business.<a href="#">Learn More</a>
                                                ...
                                                <div class="add-bor-bot">
                                                    <div class="d-flex">
                                                        <a class="btn btn-primary invoice-acc-btn collapsed pl-0" data-toggle="collapse" href="#collapseExample1" role="button" aria-expanded="false" aria-controls="collapseExample1">
                                                            <i class="fa fa-caret-down mr-1 arr-acc" aria-hidden="true"></i> Vendors Payment
                                                        </a>
                                                        <div class="ml-auto">
                                                            <a href="#" class="add-new ml-3"><i class="fa fa-plus mr-1" aria-hidden="true"></i>Add New</a>
                                                        </div>
                                    ...
                                    <div class="tab-pane fade" id="statement" role="tabpanel" aria-labelledby="statement-tab">
                                        ...
                                        <div class="text-center cus-sec">
                                            <div class="no-mails">Vendors Statement for arjun reddy</div>
                   ...
                   <?php include('inc/footer.php');?>
                    ...
                    <script>
                        $(document).ready(function() {
                            $('#customCheck1').click(function() {
                                ...
                                $(".rem-mt-5 ").removeClass("cust-table-mar");
                    ...
                    <script>
                        $(document).ready(function() {
                            $(".hov-pen").hover(function() {
                                $(".rem-dis").toggleClass("dis-none");
                            });
                        });
                        $(document).ready(function() {
                            $(".inr-hov").hover(function() {
                                $(".inr-rem").toggleClass("dis-none");
                            });
                        });
                    </script>
                    ...
                    <script>
                        $('#customCheck1').change(function() {
                            if ($(this).is(':checked')) {
                                $(".rem-bg").removeClass("dis-none");
                                $(".all-invoice-row1").addClass("d-none");
                                $(".all-invoice-row1").removeClass("d-flex");
                                $(".mark-row").removeClass("d-none");
                                $(".rem-pt-4").removeClass("pt-4");
                                $(".rem-mt-5").removeClass("mt-5");

                            } else {
                                $(".rem-bg").addClass("dis-none");
                                $(".all-invoice-row1").removeClass("d-none");
                                $(".all-invoice-row1").addClass("d-flex");
                                $(".mark-row").addClass("d-none");
                                $(".rem-pt-4").addClass("pt-4");
                                $(".rem-mt-5").addClass("mt-5");
                        ...
                        $('#customCheck2').change(function() {
                            if ($(this).is(':checked')) {
                                ...
                                $(".rem-pt-4").addClass("pt-4");
                                $(".rem-mt-5").addClass("mt-5");
                                $(".rem-mt-5 ").addClass("cust-table-mar");

                            }
                        });
                        $(document).ready(function() {
                            $(".check-cust-close").click(function() {
                                $(".all-invoice-row1").removeClass("dis-none");
                                $(".all-invoice-row1").addClass("d-flex");
                                $(".rem-pt-4").addClass("pt-4");
                                $(".rem-mt-5").addClass("mt-5");
                            });
                    ...
                    <script>
                        $(document).ready(function() {
                            $(".google-stat-sec").hover(function() {
                                $(".cust-btn").toggleClass("d-none");
                            });
                        });
                    </script>
                    ...
                    <script>
                        $(document).ready(function() {
                            $(".invoice-acc-btn1").click(function() {
                                $(".inv").toggleClass("d-none");
                                $(".acc-d").toggleClass("d-none");
                            });
                        });
                        $(document).ready(function() {
                            $(".est-btn").click(function() {
                                $(".est").toggleClass("d-none");
                                $(".est-d").toggleClass("d-none");
                            });
                        });
                        $(document).ready(function() {
                            $(".sales-btn").click(function() {
                                $(".sales").toggleClass("d-none");
                                $(".sales-d").toggleClass("d-none");
                            });
                        });
                        $(document).ready(function() {
                            $(".delivery-btn").click(function() {
                                $(".delivery").toggleClass("d-none");
                                $(".delivery-d").toggleClass("d-none");
                            });
                        });
                        $(document).ready(function() {
                            $(".rec-inv-btn").click(function() {
                                $(".rec-inv").toggleClass("d-none");
                                $(".rec-inv-d").toggleClass("d-none");
                            });
                        });
                        $(document).ready(function() {
                            $(".expense-btn").click(function() {
                                $(".expense").toggleClass("d-none");
                                $(".expense-d").toggleClass("d-none");
                            });
                        });
                        $(document).ready(function() {
                            $(".rec-exp-btn").click(function() {
                                $(".rec-exp").toggleClass("d-none");
                                $(".rec-exp-d").toggleClass("d-none");
                            });
                        });
                        $(document).ready(function() {
                            $(".project-btn").click(function() {
                                $(".project").toggleClass("d-none");
                                $(".project-d").toggleClass("d-none");
                            });
                        });
                        $(document).ready(function() {
                            $(".bill-btn").click(function() {
                                $(".bill").toggleClass("d-none");
                                $(".bill-d").toggleClass("d-none");
                            });
                        });
                        $(document).ready(function() {
                            $(".credit-note-btn").click(function() {
                                $(".credit-note").toggleClass("d-none");
                                $(".credit-note-d").toggleClass("d-none");
                            });
                        });
                    </script>
                    ...
                    <!--table script starts below-->

                    <!-- <script>
  $(document).ready(function(){
  $('.sorting-tab').click(function(){
    $(this).find('.arrow').removeClass("d-none");
...
<!-- <script type="text/javascript">  
            function load_add_customer()
            {
                console.log(zone)
                  $.ajax({  
                     url:"<?php echo  
                     $admin_url?>Customer/add_new_customer",    
                     type: "POST",    
               });  
       }  
</script> -->
   <!--<script>
      <!--table script ends above-->
                    <!-- <script>
       ...
       //console.log($admin_url);
        $.ajax({  
                     ...
                     success:function(data){  
                        ...
                        if(resp.status==true){
                            let primary_contact='';
                            let client_details =resp.data.Client_details;
                            let Customer_address=resp.data.Customer_address;
                            let other_details=resp.data.customer_other_details;
                            console.log(other_details);
                          let address_1= Customer_address[0].address_1.concat(Customer_address[0].address_2).concat(Customer_address[0].city).concat(Customer_address[0].state).concat(Customer_address[0].country_id);
                        console.log(address_1);
                            $(".check-name-clr").html(client_details[0].primary_contact);
                            $(".date_of_created").html(client_details[0].record_create_date);
                            $(".cus-name").html(client_details[0].primary_contact);
                            $(".codebele-text").html(client_details[0].company_name);
                            $(".group-name").html(client_details[0].primary_contact);
                            $(".email").html(client_details[0].email);
                            $(".work_phone").html(client_details[0].work_phone);
                            $(".work_mobile").html(client_details[0].work_mobile); 
                            $(".billing_address").html(address_1);
                            $(".mt-4").html(address_1);
                            $(".currency_code").html(other_details[0].currency);
                            $(".portal_lang").html(other_details[0].portal_lang);
                            $(".opening_balance").html(other_details[0].opening_balance);
