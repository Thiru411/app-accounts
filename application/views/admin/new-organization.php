                ...
                <div class="col-md-10">
                      ...
                      <div class="form-row mb-3">
                        ...
                        <div class="form-group col-md-6 mb-0">
                          <input type="text" name="org_name" class="form-control" id="inputname">"
                        </div>
                      </div>
                      <div class="form-row mb-3">
                        <div class="form-group col-md-2 align-self-center mb-0">
                        ...
                        <div class="form-group col-md-6 mb-0">
                           <div class="form-group  mb-0">
                                ...
                                <?php foreach($industry as $inf){?>
                                    <option value="<?=$inf->sk_industry_id?>"><?=$inf->industry?></option>
                                         <?php }?>                                    
                                </select>
                            </div>
                        </div>
                      ...
                      <div class="form-row mb-3">
                        ...
                        <div class="form-group col-md-10">
                          <input type="text" name="address1"  class="form-control" id="inputname">
                        </div>
                         <div class="form-group col-md-2 align-self-center mb-0">
                          <label for="inputname" class="mb-0"></label>
                        </div>
                        <div class="form-group col-md-10 ">
                          <input type="text" name="address2" class="form-control" id="inputname">
                        </div>
                         <div class="form-group col-md-2 align-self-center mb-0">
                          <label for="inputname" class="mb-0"></label>
                        </div>
                              ...
                              <div class="col-md-4">
                                  <div class="form-group  mb-0" >
                                        ...
                                        <?php foreach($states as $inf){?>
                                             <option value="<?=$inf->sk_state_id?>"><?=$inf->state?></option>
                                         <?php }?>  
                                        </select>
                                    </div>  
                              </div>
                              <div class="col-md-4">
                                  <div class="form-group  mb-0" >
                                        ...
                                        <?php foreach($countries as $inf){?>
                                             <option value="<?=$inf->sk_country_id?>"><?=$inf->country?></option>
                                         <?php }?>  
                                        </select>
                                    </div>  
                              </div>
                        ...
                        <div class="form-group col-md-10">
                          <div class="row">
                              <div class="col-md-4">
                                  <input type="number" name="mobile"class="form-control" id="inputname" placeholder="Phone">
                              </div>
                              <div class="col-md-4">
                                    <input type="text" name="fax" class="form-control" id="" placeholder="Fax">
                              </div>
                              <div class="col-md-4">
                                  <input type="text" name="website" class="form-control" id="inputZip" placeholder="Website">
                              </div>
                          </div>
                        </div>
                         <div class="form-group col-md-2 align-self-center mb-0">
                        ...
                        <div class="form-group col-md-6">
                            <div class="form-group  mb-0" >
                                ...
                                <?php foreach($fiscal_year as $inf){?>
                                             <option value="<?=$inf->sk_financial_year_id ?>"><?=$inf->financial_year ?></option>
                                         <?php }?>  
                                </select>
                            </div> 
                        </div>
                        ...
                        <div class="form-group col-md-10">
                            ...
                            <?php if($reportBasis){
                               ...
                               <div class="custom-control custom-radio">
                                  <input type="radio" id="customRadio1" name="repoer_basis" value="<?=$inf->sk_report_basis_id?>" class="custom-control-input">
                        ...
                        <div class="form-group col-md-6">
                            <div class="form-group  mb-0" >
                               ...
                               <?php foreach($timezone as $inf){?>
                                    <option value="<?=$inf->sk_timezone_id ?>"><?=$inf->timezone?></option>
                                         <?php }?>      
                                </select>
                            </div> 
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            <div class="form-group  mb-0" >
                               ...
                               <?php foreach($dateformat as $inf){?>
                                    <option value="<?=$inf->sk_dateformat_id ?>"><?=$inf->dateformat?></option>
                                         <?php }?>      
                                </select>
                            </div> 
                        </div>
